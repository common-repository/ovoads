=== OVOAds - Easy Ad Publisher Plugin ===
Contributors: ovosolution
Tags: ovoads, ovosolution, ad manager, ad publisher
...
We have used [Ipinfo.io Api](https://ipinfo.io) for your ads statistics in this plugin. You have to use ipinfo api key to get ads display and its statistics. Check its privacy policy (Privacy)[https://ipinfo.io/privacy-policy].

We have used [ApexChart](https://apexcharts.com) for dashboard statistics in this plugin. Check its privacy policy (Privacy)[https://apexcharts.com/privacy-policy/].

We have used Google Font [Google Font](https://fonts.googleapis.com) for text typhography in this plugin. Check its privacy policy (Privacy)[https://developers.google.com/fonts/faq/privacy]
